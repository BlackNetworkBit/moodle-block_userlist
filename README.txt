...
* Rename the vsuserlist/ folder to the name of your module (eg "widget").
...
all the instances of the string "vsuserlist" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/vsuserlist/widget/g' {} \;

* Rename the file lang/en/vsuserlist.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_vsuserlist.php
...
and you should find that this vsuserlist has been added to the list of
installed modules.
